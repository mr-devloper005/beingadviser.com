export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'bd8q2m7x4v',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Being Adviser',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'beingadviser.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://beingadviser.com',
